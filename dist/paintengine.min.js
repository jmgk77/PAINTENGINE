...
PaintEngine.prototype.run=function(){var a=this;document.getElementById(this.user.sketch_canvas).onclick=function(b){return a.tool(b)}.bind(this);this.user.prev_btn_id&&(document.getElementById(this.user.prev_btn_id).onclick=function(){return a.load_sketch(-1)}.bind(this));this.user.next_btn_id&&(document.getElementById(this.user.next_btn_id).onclick=function(){return a.load_sketch(1)}.bind(this));this.user.reload_btn_id&&(document.getElementById(this.user.reload_btn_id).onclick=function(){return a.load_sketch(0)}.bind(this));
this.user.undo_btn_id&&(document.getElementById(this.user.undo_btn_id).onclick=function(){return a.back_history()}.bind(this));this.user.redo_btn_id&&(document.getElementById(this.user.redo_btn_id).onclick=function(){return a.redo_history()}.bind(this));this.user.paint_btn_id&&(document.getElementById(this.user.paint_btn_id).onclick=function(){return a.paint()}.bind(this));this.user.erase_btn_id&&(document.getElementById(this.user.erase_btn_id).onclick=function(){return a.erase()}.bind(this));this.user.eyedrop_btn_id&&
(document.getElementById(this.user.eyedrop_btn_id).onclick=function(){return a.eyedrop()}.bind(this));this.user.sticker_btn_id&&(document.getElementById(this.user.sticker_btn_id).onclick=function(){return a.sticker()}.bind(this));this.load_sketch(0);this.paint_color=this.user.color;this.paint()};
...
PaintEngine.prototype._show_border=function(a){var b=this;this.user.css_class_border&&([this.user.erase_btn_id,this.user.paint_btn_id,this.user.eyedrop_btn_id,this.user.sticker_btn_id].forEach(function(a){document.getElementById(a)&&document.getElementById(a).classList.remove(b.user.css_class_border)}),a&&document.getElementById(a).classList.add(this.user.css_class_border))};
PaintEngine.prototype.erase=function(){this._show_border(this.user.erase_btn_id);this.tool=this.bucket_tool;this.user.color={r:255,g:255,b:255,a:255};this._show_current_color()};PaintEngine.prototype.eyedrop=function(){this._show_border(this.user.eyedrop_btn_id);this.tool=this.eyedropper_tool};PaintEngine.prototype.eyedropper_tool=function(a){this._get_color_xy(this.user.sketch_canvas,a)};
